...
class Inscricao(models.Model):
    participante = models.ForeignKey(PessoaFisica, related_name="inscrições", null=True, blank=False)
    evento = models.ForeignKey(Evento, related_name="inscrições", null=True, blank=False)
